...
/**
 * @name Circular
 * @description A circular linked list is a linked list where every element's next property points to the next element.
 ...
 * c.next = b;
 * circular(l) // true
 * Implement the solution to check if a linked list is circular. Use MyLinkedList.
 */
public class Circular {
  static public boolean solution(MyLinkedList list) {
